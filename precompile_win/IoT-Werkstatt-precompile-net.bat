...
echo.
echo =====Network-Libs, Zielplattform waehlen ===============
...
REM CHOICE setzt ERRORLEVEL: 1 fuer Taste '1', 2 fuer '2'
set "FQBN="
if errorlevel 2 set "FQBN=esp8266:esp8266:octopus_core_cpp"
if errorlevel 1 if not defined FQBN set "FQBN=esp32:esp32:makey_v1:inject=off"
...
powershell -NoLogo -NoProfile -ExecutionPolicy Bypass ^
  -File "%ROOT%precompile_win\IoT-Werkstatt-precompile-net.ps1" ^
